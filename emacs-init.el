...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((org-babel-default-header-args (:results . "replace output") (:session . "*R*") (:exports . "none")) (noweb-default-code-mode . R-mode) (outline-minor-mode)))))
(if nil
    (custom-set-faces
