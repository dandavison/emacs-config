...
#+end_src
*** Appearance
***** TODO Set org-hide face according to current background face / color theme
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  ;; (remove-hook 'org-font-lock-hook 'dan/org-fontify-image-links)
