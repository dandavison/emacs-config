...
#+begin_src emacs-lisp
  ...
  (setq ded/org-babel-languages '("R" "python" "ruby" "ditaa" "latex" "asymptote" "dot" "sass" "perl" "sql"))
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'iimage-mode-image-regex-alist
               (cons (concat "\\[\\[file:\\(~?" iimage-mode-image-filename-regex
                             "\\)\\]")  1))
  (defun ems/org-toggle-iimage-in-org ()
    (interactive)
  ...
  (defun ded/org-toggle-iimage-in-org ()
    (interactive)
