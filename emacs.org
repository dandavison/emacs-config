...
*** Eshell
#+begin_src emacs-lisp
  (defun dan/eshell-mode-hook-fun ()
    (setenv "PATH"
            (concat
  ...
  (add-hook 'eshell-mode-hook 'dan/eshell-mode-hook-fun)
...
#+begin_src emacs-lisp
  ...
  (when (dan/require 'yasnippet)
    ...
    (yas/load-directory "~/lib/emacs/Worg/org-contrib/babel/snippets")
    (yas/load-directory "~/lib/emacs/yasnippet-ess")
...
***** General
#+begin_src emacs-lisp
(setq org-latex-to-pdf-process '("rubber -d --into %o %f"))
#+end_src
***** Latex export hook
...
**** Org-fold
#+begin_src emacs-lisp :tangle no
  (add-to-list 'load-path "~/lib/emacs/orgfold")
