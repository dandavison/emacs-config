...
** find
#+begin_src emacs-lisp
(setq dan/find-command
  (concat "find %s " 
          "\\( -path \\*/.git -o -path \\*/migrations \\) -prune "
          "-o -type f \\( -iname \\*.py -o -iname \\*.coffee -iname \\*.js -o -iname \\*.html -o -iname \\*.css \\) "
...
** paint buffer accprding to predicate function
#+begin_src emacs-lisp
...
** git
   ...
   (defun dan/git-dir ()
     ...
     (interactive)
     (file-name-directory
      (org-babel-chomp (shell-command-to-string "git rev-parse --git-dir"))))   
   #+end_src
...
** Emacs Chrome
#+begin_src emacs-lisp
(add-to-list 'load-path "~/lib/browser-extensions/emacs_chrome/servers")
(require 'edit-server)
(edit-server-start)
#+end_src
