...
(defun esk/pretty-lambdas (&optional keyword)
  (interactive "sString: ")
  (font-lock-add-keywords
   nil `(((format "(?\\(%s\\>\\)" (or keyword "lambda"))
...
(add-hook 'js-mode-hook '(lambda () (esk/pretty-lambdas "function")))
...
(global-set-key (kbd "s-i") 'dan/eol-column-line)
