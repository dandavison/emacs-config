...
#+begin_src emacs-lisp
  ...
  (defun dan/find-file-at-point-python-import ()
    (interactive)
    (push
     (concat
      "~/base/site/"
      (subst-char-in-string
       ?. ?/ (thing-at-point 'python-import)) ".py")
     file-name-history)
...
*** General
#+begin_src emacs-lisp
  ;; (when (eq dan/operating-system 'darwin)
  ...
  (dan/register-key-bindings
   '("org" .
     (("\C-ch" . dan/hide-subtree)
      ...
      ("_" . self-insert-command) ;; dan/org-underscore-command)
...
#+begin_src emacs-lisp
  ...
  (setq ido-separator " ")
  (eshell)
  (when (and (eq dan/operating-system 'darwin)
